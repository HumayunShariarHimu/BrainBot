...
const loadQuestions = async () => {
  try {
    const response = await fetch("/elements/text/question.txt");
...
const setDefaultChatText = () => {
  const defaultText = `<div class="default-text">
    <a class="BrainBot" href="/index.html" target="_blank"><img src="https://raw.githubusercontent.com/HumayunShariarHimu/BrainBot/refs/heads/main/favicon.png" alt="BrainBot" width="100px;" height="100px"></a>
